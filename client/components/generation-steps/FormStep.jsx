...
const CardDataForm = dynamic(() => import('../ui/CardDataForm'), {
  loading: () => <Loader />,
});
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="divide-x-4 divide-violet-600 flex flex-col-reverse sm:flex-row items-center justify-evenly">
        ...
        <div className="sm:w-1/2 m-2 p-4 text-black">
          ...
          <p className="mt-4">
            You can create ID cards by Filling out the form on the left side of
            this page. You can also upload your own image to be used as the
