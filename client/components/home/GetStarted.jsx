function GetStarted() {
  return (
    <section className="min-h-screen flex flex-col sm:flex-row justify-center items-center relative overflow-hidden py-10 sm:py-20">
      ...
      <div className="flex flex-col items-center justify-center mx-auto px-4 sm:px-6 lg:px-8 sm:w-1/2">
        <form className="w-full border-2 border-teal-500 rounded-lg mx-auto px-4 sm:px-6 lg:px-8">
          Register
        </form>
      </div>
